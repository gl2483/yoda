...
public class routes {
  ...
  public static final controllers.ReverseRequestSession RequestSession = new controllers.ReverseRequestSession(RoutesPrefix.byNamePrefix());
  ...
  public static final controllers.ReverseSessions Sessions = new controllers.ReverseSessions(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseRequestSession RequestSession = new controllers.javascript.ReverseRequestSession(RoutesPrefix.byNamePrefix());
    ...
    public static final controllers.javascript.ReverseSessions Sessions = new controllers.javascript.ReverseSessions(RoutesPrefix.byNamePrefix());
  }
